        ...
        <div className="row justified">
            ...
            <div className="col-12 col-lg-6">
                <p>
                    ...
                    komponiert habe, als Lehrender entdecke ich gemeinsam mit meinen Lernenden neue Nuancen und Aspekte
                    die ich dann als Komponist verwenden kann. Es ließen sich noch viele Beispiele finden. Dieser
                    Kreislauf macht mich glücklich und deshalb ist es mir ein Anliegen, dass diese „Dreieinigkeit“ auch
                    auf meiner Webseite zum Ausdruck gebracht wird.“
                </p>
            </div>
        </div>
    );
